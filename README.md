...
![](https://github.com/EdilAbe/tdd-student-store-starter/blob/main/Walkthrough2.gif)
...
The labs alone were very helpful for this week's project.
...
I had a hard time working on add/remove items from the shopping cart.
