...
Selling merchandise in the modern era requires digital solutions. For this project, you'll be tasked with designing and constructing an online student store for the College of Codepath. The application entails a frontend user interface for potential customers to peruse the goods, and a backend API to handle data management. The API will be built with Node and Express and the UI will be built with React.
 ...
 ![](https://github.com/EdilAbe/tdd-student-store-starter/blob/main/Walkthrough1.gif)
...
The Labs were super helpful but it would have been more helpful to have a sidebar feature in one in one of our labs.


* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
If I had more time, I would add a checkout page that displays the items in the shopping cart and similiar items to the one purchased.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

I spent a lot of time trying to display the products and working on the sidebar.
